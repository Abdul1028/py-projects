...
def message_func(text, is_user=False, is_df=False):
    ...
    """
    if is_user:
        avatar_url = "https://lh3.googleusercontent.com/a/ACg8ocKHIsmBx2N_v0CPuhk65JTjah8cfGJPTJtZf-l4YJFjaoy0=s576-c-no"
            ...
            f"""
                <div style="display: flex; align-items: center; margin-bottom: 10px; justify-content: {message_alignment};">
                    <div style=" background: {message_bg_color}; color: white; border-radius: 20px; padding: 10px; margin-right: 5px; max-width: 75%; font-size: 14px;">
                        {text} \n </div>
                    <img src="{avatar_url}" class="{avatar_class}" alt="avatar" style="width: 50px; border-radius:40px; height: 50px;" />
                </div>
                """,
